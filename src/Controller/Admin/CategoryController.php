...
class CategoryController extends AbstractController
{
    ...
    {
        $catlist = $categoryRepository->findBy(['parentid' => 'id']);


dump($catlist);

        return $this->render('admin/category/frontbase.html.twig', [
     ...
     */
    public function show(Category $category, CategoryRepository $categoryrepository,$pid): Response
    {
        $catlist = $categoryrepository->findBy(['parentid' => 0]);
