...
class MessagesController extends AbstractController
{
    ...
    {
        return $this->render('admin/messages/frontbase.html.twig', ['messages' => $messagesRepository->findAll()]);
    }
    ...
    public function show(Messages $message,$id): Response
    {
        ...
        $em=$this->getDoctrine()->getManager();
        $sql= 'UPDATE messages SET status="Been Read"  WHERE id= :id';
     ...
     */
    public function message_update(Messages $message,$id,Request $request): Response
    {
        ...
        $statement ->bindValue('id',$id);
        $statement->execute();
        $this->addFlash('success','Your Comment was Edited');
        return $this->render('admin/messages/show.html.twig', ['message' => $message,
            'id' =>$id]);
    }
